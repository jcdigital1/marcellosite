...
export function ValueCTA() {
  return (
    <section className="py-16 px-4 sm:px-6 md:px-8 max-w-4xl mx-auto relative">
      ...
      <div className="relative rounded-3xl p-px bg-gradient-to-b from-sky-400/50 via-sky-500/20 to-sky-950 shadow-[0_25px_60px_rgba(0,0,0,0.9),0_0_35px_rgba(56,189,248,0.2)]">
        <div className="rounded-3xl p-8 sm:p-14 bg-gradient-to-b from-[#0c1836] via-[#081024] to-[#050a17] text-center overflow-hidden relative">
          ...
          {/* Tactile 3D Action Button com Link Direto do WhatsApp */}
          <div className="mt-8 flex justify-center">
            <a
              href={BROKER_INFO.whatsappUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto min-h-[56px] px-10 sm:px-14 py-4 rounded-xl btn-3d text-white font-bold text-sm sm:text-base tracking-[0.15em] uppercase inline-flex items-center justify-center gap-3 cursor-pointer shadow-2xl transition-all group"
            >
              {/* WhatsApp Icon */}
              <svg
                viewBox="0 0 24 24"
                ...
                height="24"
                fill="currentColor"
                className="text-emerald-300 group-hover:scale-110 transition-transform shrink-0 drop-shadow-[0_0_8px_rgba(52,211,153,0.6)]"
                aria-hidden="true"
              >
